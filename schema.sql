...
-- Safe to run multiple times (uses IF NOT EXISTS + TRUNCATE)
...
-- Clear old data and re-seed (comment out if you want to keep existing bookings)
...
-- Verify
SELECT id, name, available_seats, price FROM concerts;
